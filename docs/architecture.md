...
Agent 也可直接请求 Midway（例如 `http://localhost:7001/api/courses?keyword=react`），按 [manage-courses Skill](./skills/manage-courses.md) 路由课程查询或创建并解释结果；课程列表 API 支持可选服务端关键词参数。
